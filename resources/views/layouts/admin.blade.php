...
<div class="flex h-screen overflow-hidden">
    ...
    >
        ...
        <div class="flex flex-col h-full min-h-0">
            ...
            <nav
                class="admin-sidebar-nav flex-1 px-3 py-2 overflow-y-auto text-xs"
            >
                ...
                <div
                    class="px-3 pt-1 pb-1 text-[9px] font-black uppercase tracking-wider text-emerald-500/80"
                >
                    Vue globale
                </div>
                ...
                <div
                    class="px-3 pt-3 pb-1 text-[9px] font-black uppercase tracking-wider text-emerald-500/80"
                >
                    Utilisateurs & sécurité
                </div>
                ...
                <a
                    href="{{ route('admin.financial-engine.index') }}"
                    @click="sidebarOpen = false"
                    class="flex items-center gap-3 px-3 py-2 rounded-xl font-semibold transition-all
