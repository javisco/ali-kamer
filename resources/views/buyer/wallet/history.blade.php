    ...
    <div class="min-h-screen bg-[#F7F7F2] py-6 sm:py-8">
        <div class="max-w-3xl mx-auto px-4">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div
                    class="w-10 h-10 rounded-xl bg-[#016837] text-white
            ...
            @if ($transactions->isEmpty())
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm
                    ...
                    <div
                        class="mx-auto w-14 h-14 rounded-2xl bg-[#F9A01B]/10
                            ...
                            <div
                                ...
                                <div class="flex-1 min-w-0 pr-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        {{ $tx->isCredit() ? 'bg-[#016837]/10 text-[#016837]' : 'bg-[#E30613]/10 text-[#E30613]' }}">
                                ...
                                <div class="text-right flex-shrink-0">
                                    ...
                                    {{ $tx->isCredit() ? 'text-[#016837]' : 'text-[#E30613]' }}">
                                    ...
                                    <span
                                        class="inline-block mt-1 text-[9px] font-bold
                                    uppercase tracking-wide
                                    {{ $tx->isCredit() ? 'text-[#016837] bg-[#016837]/10' : 'text-[#E30613] bg-[#E30613]/10' }}
