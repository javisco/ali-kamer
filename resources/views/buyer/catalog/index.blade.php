...
========================================================== --}}
          ...
          transition-all duration-200 flex flex-col">
                            ...
                            {{-- IMAGE --}}
                            <div class="relative aspect-[1/0.95] bg-slate-100 overflow-hidden">
                        ...
                        bg-gradient-to-br from-slate-50 to-slate-100">
                                ...
                                @if ($product->shipping_included)
                                    <span
                                        class="absolute top-1.5 left-1.5 px-1.5 py-1
                         rounded-md bg-[#00843D] text-white
                         text-[7px] sm:text-[8px] font-black shadow-sm">
                                        🚚 Inclus
                                    </span>
                                @endif
                                ...
                                @if ($hasDiscount && $discountPercent > 0)
                                    <span
                                        class="absolute top-1.5 right-1.5 px-1.5 py-1
                         rounded-md bg-[#CE1126] text-white
                         text-[8px] font-black shadow-sm">
                                        -{{ $discountPercent }}%
                                    </span>
                                @endif
                         ...
                         text-[7px] font-black">
                            ...
                            <div class="p-2 flex flex-col">
                                ...
                                {{-- TITRE --}}
                                <h3
                                    class="text-[10px] sm:text-[11px] font-bold text-slate-900
                   leading-[1.25] ak-line-clamp-2
                   group-hover:text-[#00843D] transition">
                                ...
                                <div class="mt-1.5 flex items-baseline gap-1 flex-wrap">
                                    ...
                                    <span class="text-[7px] font-black text-slate-500">
                                        FCFA
                                    </span>

                                    @if ($hasDiscount)
                                        <span class="text-[8px] text-slate-400 line-through font-bold">
                                ...
                                {{-- BOUTIQUE + VILLE --}}
                                @if ($product->shop)
                                    <div class="mt-1.5 flex items-center gap-1 min-w-0">

                                        <span
                                            class="text-[8px] sm:text-[9px] font-black
                             text-slate-600 truncate">
                                            {{ $product->shop->name }}
                                        </span>

                                        @if ($product->shop->verified_at)
                                            <svg class="w-2.5 h-2.5 text-[#00843D] shrink-0" fill="currentColor"
                                                viewBox="0 0 20 20">
                                    ...
                                    <div class="mt-0.5 text-[7px] text-slate-400 truncate">
                                ...
                                <div class="mt-1.5 flex items-center justify-between gap-1">
                                    ...
                                    <span class="text-[7px] text-slate-400 truncate">
                                        {{ number_format($salesCount, 0, ',', ' ') }}
                                        {{ $salesCount > 1 ? 'ventes' : 'vente' }}
                                    </span>

                                    <span
                                        class="shrink-0 text-[7px] font-black
                         text-[#00843D] bg-emerald-50
                         px-1.5 py-0.5 rounded">
                                ...
                                {{-- TRANSPORT --}}
                                <div class="mt-1 text-[7px] font-bold truncate">
