...
@section('content')
    ...
    ========================================================== --}}
            ...
            <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
                <div class="min-h-[34px] flex items-center justify-center sm:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold">
                        <span
                            class="w-4 h-4 rounded-full bg-[#FCD116] text-[#004D2A] flex items-center justify-center text-[9px] font-black">
                            ✓
                        </span>
        ...
        2. HERO
    ========================================================== --}}
        <section x-data="{ heroVisible: true }" x-init="setTimeout(() => heroVisible = false, 30000)" x-show="heroVisible"
            x-transition:leave="transition ease-in-out duration-700"
            x-transition:leave-start="opacity-100 translate-y-0 max-h-[1200px]"
            x-transition:leave-end="opacity-0 -translate-y-3 max-h-0"
            class="relative overflow-hidden bg-gradient-to-b from-[#F0FAF4] via-white to-[#FAF9F6] border-b border-slate-200/70">
            ...
            <div class="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-7 sm:py-9 lg:py-12">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-7 items-stretch">
                    ...
                    {{-- HERO PRINCIPAL --}}
                    <div
                        class="lg:col-span-8 relative overflow-hidden rounded-[28px] bg-gradient-to-br from-[#004D2A] via-[#006B32] to-[#00843D] text-white shadow-xl shadow-emerald-950/10">
 
                        {{-- Motifs --}}
                        <div class="absolute -right-16 -top-16 w-64 h-64 rounded-full border-[30px] border-white/5"></div>
                        <div
                            class="absolute -right-28 bottom-[-100px] w-80 h-80 rounded-full border-[40px] border-[#FCD116]/10">
                        </div>
                        ...
                        <div class="relative z-10 p-6 sm:p-8 lg:p-10 xl:p-12">
                            ...
                            <div class="max-w-2xl">
                                ...
                                <div
                                    class="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/15 px-3 py-1.5 text-[10px] sm:text-[11px] font-extrabold backdrop-blur-sm">
                                ...
                                <div class="mt-7 flex flex-wrap gap-3">
                                    ...
                                    @if (Route::has('register.seller'))
                                        <a href="{{ route('register.seller') }}"
                                            ...
                                            <svg class="w-4 h-4 text-[#FCD116]" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                ...
                                <div class="mt-8 pt-5 border-t border-white/10 flex flex-wrap gap-x-5 gap-y-2">
                                    ...
                                    <div
                                        class="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold text-emerald-50">
                    ...
                    <div class="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-5">
                        ...
                        {{-- Carte sécurité --}}
                        <div
                            class="relative overflow-hidden rounded-[24px] bg-white border border-slate-200 p-5 sm:p-6 shadow-sm hover:shadow-md transition">
                            ...
                            <div class="relative">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span
                                        class="w-11 h-11 rounded-2xl bg-emerald-50 text-[#00843D] flex items-center justify-center text-xl">
                                        🛡️
                                    </span>
 
                                    <span
                                        class="text-[9px] font-black uppercase tracking-wider text-[#00843D] bg-emerald-50 px-2 py-1 rounded-full">
                                        Sécurité
                                    </span>
                                ...
                                <p class="mt-1.5 text-xs text-slate-500 leading-relaxed">
                                    Le paiement et la livraison suivent les étapes prévues par Ali-Kamer avant la
                                    finalisation de la commande.
                                </p>
 
                                @if (Route::has('how-it-works'))
                        ...
                        {{-- Carte vendeur --}}
                        <div
                            class="relative overflow-hidden rounded-[24px] bg-gradient-to-br from-[#FFFBEB] via-white to-[#FFF7ED] border border-amber-200 p-5 sm:p-6 shadow-sm hover:shadow-md transition">
 
                            <div class="flex items-center justify-between">
 
                                <span
                                    class="w-11 h-11 rounded-2xl bg-[#FCD116]/30 flex items-center justify-center text-xl">
                                    🏪
                                </span>
 
                                <span
                                    class="text-[9px] font-black uppercase tracking-wider text-amber-700 bg-amber-100 px-2 py-1 rounded-full">
                                    Vendeur
                                </span>
            ...
            <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
                    ...
                    <div class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition">
                        <div
                            class="w-10 h-10 rounded-xl bg-emerald-50 text-[#00843D] flex items-center justify-center shrink-0">
                            🔒
                        </div>
                    ...
                    @foreach ($categoriesList as $cat)
                        ...
                        <a href="{{ route('buyer.home', ['category' => $cat['slug']]) }}#produits"
                            ...
                            <div class="flex justify-center">
                                ...
                                <span
                                    class="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center text-xl sm:text-2xl {{ $colorClasses }}">
                                    {{ $cat['icon'] }}
                                </span>
                            ...
                            <p
                                class="mt-2 text-[10px] sm:text-[11px] text-center font-extrabold text-slate-700 group-hover:text-[#00843D] ak-line-clamp-1">
                                {{ $cat['name'] }}
                            </p>
    ...
    ========================================================== --}}
        <section id="produits" class="bg-white border-y border-slate-200/70 py-8 sm:py-10 scroll-mt-20">
            ...
            'mode' => '👕 Mode',
                ...
                {{-- PRODUITS (même nombre de colonnes qu'avant, cartes plus grandes) --}}
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 sm:gap-4">
                    ...
                    @forelse ($products as $product)
                        ...
                        @php
                            ...
                            // Chargé une seule fois par le CatalogController.
                        ...
                        {{-- =========================================================
                        CARTE PRODUIT
                        Ordre : titre > prix (+ ancien prix rouge barré) > boutique/ville
                        > ventes/quantité min. > transport.
                        Les infos courtes sont côte à côte et passent à la ligne
                        seulement quand la place manque.
                        ========================================================== --}}
                        <a href="{{ route('product.show', ['product' => $product->id]) }}"
                            class="group min-w-0 bg-white rounded-xl overflow-hidden border border-slate-200
                                   hover:border-[#00843D] hover:shadow-md hover:-translate-y-0.5
                                   transition-all duration-200 flex flex-col">
 
                            {{-- IMAGE (plus haute qu'avant) --}}
                            <div class="relative aspect-[1/1.12] bg-slate-100 overflow-hidden">
                                ...
                                {{-- TRANSPORT : toujours affiché sur l'image (inclus ou à prévoir) --}}
                                @if ($product->shipping_included)
                                    <span title="Transport inclus"
                                        class="absolute top-2 left-2 px-2 py-1 rounded-md bg-[#00843D] text-white
                                               text-[9px] sm:text-[10px] font-black shadow-sm">
                                        🚚 Inclus
                                    </span>
                                @else
                                    <span title="Transport à prévoir"
                                        class="absolute top-2 left-2 px-2 py-1 rounded-md bg-white/95 text-slate-700
                                               border border-slate-200 text-[9px] sm:text-[10px] font-black shadow-sm">
                                        🚚 À prévoir
                                    </span>
                                @endif
                                ...
                                @if ($hasDiscount && $discountPercent > 0)
                                    <span
                                        class="absolute top-2 right-2 px-2 py-1 rounded-md bg-[#CE1126] text-white
                                               text-[10px] sm:text-[11px] font-black shadow-sm">
                                        -{{ $discountPercent }}%
                                    </span>
                                @endif
                                ...
                                @if ($availableStock <= 0 || $product->status === 'sold_out')
                                    <span
                                        class="absolute bottom-2 right-2 px-2 py-1 rounded-md bg-slate-950/85 text-white
                                               text-[9px] sm:text-[10px] font-black">
                                        Épuisé
                                    </span>
                                @elseif ($availableStock <= 5)
                                    <span
                                        class="absolute bottom-2 right-2 px-2 py-1 rounded-md bg-[#FCD116] text-slate-950
                                               text-[9px] sm:text-[10px] font-black">
                            ...
                            <div class="p-2.5 sm:p-3 flex flex-col gap-1.5 flex-1">
                                ...
                                {{-- 1. TITRE (première information) --}}
                                <h3
                                    class="text-[13px] sm:text-sm font-bold text-slate-900 leading-snug
                                           ak-line-clamp-2 group-hover:text-[#00843D] transition">
                                    {{ $product->title }}
                                </h3>
 
 
                                {{-- 2. PRIX + ANCIEN PRIX (rouge, barré) côte à côte --}}
                                <div class="flex items-baseline flex-wrap gap-x-2 gap-y-0.5">
                                    ...
                                    <span class="inline-flex items-baseline gap-1">
                                        ...
                                        <span class="text-[10px] sm:text-[11px] font-black text-slate-500">
                                            FCFA
                                        </span>
                                    </span>
                                    ...
                                    @if ($hasDiscount)
                                        <span
                                            class="text-[11px] sm:text-xs font-bold text-[#CE1126] line-through decoration-[#CE1126]">
                                ...
                                {{-- 3. BOUTIQUE + VILLE côte à côte --}}
                                @if ($product->shop)
                                    <div
                                        class="flex flex-wrap items-center gap-x-2 gap-y-0.5 min-w-0
                                            ...
                                            @if ($product->shop->verified_at)
                                                <svg class="w-3.5 h-3.5 text-[#00843D] shrink-0" fill="currentColor"
                                                    ...
                                                    <path fill-rule="evenodd"
                                                        d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414 0L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l5-5a1 1 0 00-1.414-1.414z"
                                                        clip-rule="evenodd" />
                                ...
                                {{-- 4. VENTES + QUANTITÉ MIN. côte à côte --}}
                                <div class="flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] sm:text-xs">
                                    ...
                                    <span
                                        class="text-[10px] sm:text-[11px] font-black text-[#00843D] bg-emerald-50
                                               px-2 py-0.5 rounded">
                                        Min. {{ $minQuantity }}
                                    </span>
                    ...
                    @empty
                        ...
                        <div class="col-span-full py-12">
                            ...
                            <div class="max-w-lg mx-auto text-center">
                                ...
                                <div
                                    class="w-16 h-16 mx-auto rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-center text-2xl">
                                    🔎
                                </div>
            ...
            <section class="bg-white py-10 sm:py-12 border-t border-slate-200/70">
                ...
                <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="relative overflow-hidden rounded-[28px] bg-[#FFFBEB] border border-amber-200">
                        ...
                        <div
                            class="relative z-10 p-6 sm:p-8 lg:p-10 flex flex-col lg:flex-row lg:items-center justify-between gap-7">
 
                            <div class="max-w-2xl">
 
                                <span
                                    class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-amber-200 text-amber-700 text-[10px] font-black uppercase tracking-wider">
                                    Espace vendeur
                                </span>
