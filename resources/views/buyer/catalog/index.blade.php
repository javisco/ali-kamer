        ...
        <div class="relative max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="min-h-[300px] lg:min-h-[322px] grid lg:grid-cols-[1fr_1.05fr] items-center">
                ...
                <div class="relative z-10 py-8 lg:py-7">
                    <h1 class="text-[44px] sm:text-[54px] lg:text-[62px] leading-[0.98] font-black tracking-tight text-slate-950">
                        <span class="text-[#00843D]">Ali</span><span class="text-[#CE1126]">-</span><span class="text-slate-950">Kamer</span>
                    </h1>
                    ...
                    <div class="mt-5 flex flex-wrap items-center gap-x-7 gap-y-2.5 text-[11px] font-bold text-slate-700">
                        <div class="flex items-center gap-2">
                            <span class="flex h-7 w-7 items-center justify-center rounded-full bg-[#00843D] text-white">✓</span>
                            Achat sécurisé
                        </div>
                        <div class="flex items-center gap-2">
                            <span class="flex h-7 w-7 items-center justify-center rounded-full bg-[#00843D] text-white">▣</span>
                ...
                <div class="relative h-full min-h-[300px] flex items-center justify-center lg:justify-end pr-0 lg:pr-24">

                    {{-- Halo continental --}}
                    <div class="absolute inset-y-4 left-8 right-20 rounded-full
                                bg-[radial-gradient(circle_at_center,rgba(0,132,61,.15),transparent_68%)]"></div>

                    {{-- Afrique stylisée : le Cameroun est le point de départ mis en évidence --}}
                    <div class="relative z-10 w-[250px] sm:w-[285px] lg:w-[330px]">
                        <svg viewBox="0 0 360 390" class="w-full h-auto drop-shadow-md" aria-label="Afrique avec le Cameroun mis en évidence">
                            <defs>
                                <linearGradient id="akAfricaGreen" x1="0" y1="0" x2="1" y2="1">
                                    <stop offset="0%" stop-color="#006B32"/>
                                    <stop offset="55%" stop-color="#00843D"/>
                                    <stop offset="100%" stop-color="#0A9B4E"/>
                                </linearGradient>
                                <linearGradient id="akCameroon" x1="0" y1="0" x2="1" y2="1">
                            ...
                            {{-- Silhouette africa --}}
                            <path d="M164 17c31-10 66 0 79 25 12 23 8 39 31 53 20 13 34 38 27 58-6 17-22 26-21 44 2 25 29 43 20 67-9 26-39 33-52 51-13 18-14 47-33 55-18 8-39-11-56-27-17-16-36-24-46-44-10-19-7-41-18-58-13-19-38-30-46-53-9-23 4-47 21-64 17-17 33-29 41-51 7-23 17-55 53-56z"
                                  fill="url(#akAfricaGreen)"
                                  stroke="#006B32"
                                  stroke-width="4"/>

                            {{-- Lignes décoratives discrètes pour donner une lecture continentale --}}
                            <path d="M91 106c38 12 75 14 113 5 34-8 61-5 88 10" fill="none" stroke="#FCD116" stroke-width="3" opacity=".65"/>
                            <path d="M78 207c40-9 76-3 112 12 36 15 68 17 99 7" fill="none" stroke="#FFFFFF" stroke-width="2.5" opacity=".32"/>
                            <path d="M104 286c34-14 70-13 106 2 31 13 52 13 75 4" fill="none" stroke="#CE1126" stroke-width="3" opacity=".55"/>

                            {{-- Zone Cameroun mise en exergue --}}
                            <g filter="url(#akGlow)">
                                <circle cx="139" cy="178" r="27" fill="#CE1126" opacity=".24"/>
                                <circle cx="139" cy="178" r="18" fill="url(#akCameroon)" stroke="#FFFFFF" stroke-width="4"/>
                            ...
                            <path d="M151 178 C174 168, 190 165, 211 166" fill="none" stroke="#CE1126" stroke-width="3"/>
                            <circle cx="214" cy="166" r="4" fill="#FCD116" stroke="#CE1126" stroke-width="2"/>

                            {{-- Label --}}
                            <g>
                                <rect x="207" y="139" width="110" height="48" rx="12" fill="white" stroke="#CE1126" stroke-width="2"/>
                                <text x="218" y="158" font-family="Arial, sans-serif" font-size="10" font-weight="800" fill="#CE1126">🇨🇲 CAMEROUN</text>
                                <text x="218" y="174" font-family="Arial, sans-serif" font-size="8.5" font-weight="700" fill="#334155">Notre point de départ</text>
                            </g>
                        </svg>
                    ...
                    <div class="absolute right-0 top-1/2 z-30 hidden xl:flex -translate-y-1/2 flex-col gap-4">
                        <div class="flex items-center gap-3">
                            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#00843D] text-lg text-white">🔒</span>
                            <span class="w-28 text-xs font-bold leading-tight text-slate-700">Des transactions<br>sécurisées</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#00843D] text-lg text-white">🚚</span>
                            <span class="w-28 text-xs font-bold leading-tight text-slate-700">Un réseau<br>d'agences fiable</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#00843D] text-lg text-white">📱</span>
                            <span class="w-28 text-xs font-bold leading-tight text-slate-700">MTN MoMo<br>Orange Money</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#00843D] text-lg text-white">👥</span>
                            <span class="w-28 text-xs font-bold leading-tight text-slate-700">Une plateforme<br>100% africaine</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                @foreach ($categoriesList as $cat)
                    ...
                    <a href="{{ route('buyer.home', ['category' => $cat['slug']]) }}"
                       class="group min-w-0 flex flex-col items-center text-center
                        ...
                        <span class="w-11 h-11 sm:w-12 sm:h-12 rounded-xl
                                     flex items-center justify-center text-2xl
                                     {{ $toneClasses }} transition">
                            {{ $cat['icon'] }}
                        </span>

                        <span class="mt-2 text-[10px] sm:text-xs font-extrabold
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2.5 sm:gap-3">
                       ...
                       class="group min-w-0 bg-white border border-slate-200 rounded-2xl
                        ...
                        <div class="relative aspect-[1.12/1] bg-slate-100 overflow-hidden">
                            ...
                            @if ($product->shipping_included)
                                <span class="absolute top-2 left-2 px-2 py-1 rounded-md
                                             bg-[#00843D] text-white text-[9px] font-black shadow-md">
                                    Transport inclus
                                </span>
                            @endif

                            @if ($hasDiscount && $discountPercent > 0)
                                <span class="absolute top-2 right-2 px-2 py-1 rounded-md
                            ...
                            @if ($availableStock <= 0 || $product->status === 'sold_out')
                                <span class="absolute bottom-2 right-2 px-2 py-1 rounded-md
                        ...
                        <div class="p-2.5 sm:p-3 flex flex-col flex-1">
                            ...
                            @if ($product->shop)
                                <div class="flex items-center gap-1 min-w-0">
                                    ...
                                    @if ($product->shop->verified_at)
                                        <svg class="w-3.5 h-3.5 text-[#00843D] shrink-0"
                            ...
                            <h3 class="mt-1.5 text-xs sm:text-sm font-bold text-slate-900
                            ...
                            <div class="mt-1 flex items-center gap-1.5 text-[10px] text-slate-500">
                                ...
                                <span class="inline-flex items-center rounded-md bg-emerald-50 px-1.5 py-0.5
                ...
                @empty
                    ...
                    <div class="col-span-full">
                        <div class="bg-[#FAF9F6] border border-dashed border-slate-300
                                    rounded-3xl p-10 sm:p-12 text-center max-w-md mx-auto">

                            <div class="w-14 h-14 bg-white rounded-2xl flex items-center
        ...
        <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
            ...
            <div class="bg-white border border-slate-200 rounded-[2rem]
                    ...
                    <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="relative">
                            <div class="flex items-start gap-3">
                                <span class="w-10 h-10 rounded-2xl bg-[#00843D]
                        ...
                        <div class="relative">
                            <div class="flex items-start gap-3">
                                <span class="w-10 h-10 rounded-2xl bg-[#FCD116]
                        ...
                        <div class="relative">
                            <div class="flex items-start gap-3">
                                <span class="w-10 h-10 rounded-2xl bg-[#CE1126]
                                             text-white flex items-center justify-center
                                             font-black shrink-0">
                                    3
                                </span>
                ...
                <div class="border-t border-slate-100 bg-gradient-to-r from-emerald-50 via-white to-yellow-50">
                    <div class="p-5 sm:p-6 flex flex-col sm:flex-row
                                items-start sm:items-center justify-between gap-5">

                        <div class="flex items-center gap-3">
                            <span class="w-11 h-11 rounded-2xl bg-[#FCD116]
                        ...
                        <a href="{{ route('about') }}"
                           class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl
                            ...
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      stroke-width="2" d="M13 5l7 7-7 7M20 12H4"/>
                            </svg>
                        </a>
                    </div>
                </div>
