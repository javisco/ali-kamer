...
<div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="max-w-3xl">
        <span class="inline-block rounded-full bg-[#00843D]/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-[#00843D]">Centre d'aide</span>
    ...
    <div class="mt-8 grid gap-4 md:grid-cols-2">
        <article class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm hover:shadow-md transition">
            ...
            <div class="mt-4 flex gap-2">
                <a href="{{ route('login') }}" class="rounded-lg bg-slate-900 hover:bg-slate-800 px-3 py-2 text-xs font-bold text-white transition">Se connecter</a>
                <a href="{{ route('register.show') }}" class="rounded-lg border border-slate-200 bg-slate-50 hover:bg-slate-100 px-3 py-2 text-xs font-bold text-slate-700 transition">Créer un compte</a>
            </div>
        </article>
        ...
        <article class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm hover:shadow-md transition">
            ...
            <a href="{{ route('buyer.home') }}" class="mt-4 inline-block text-xs font-black text-[#00843D] hover:underline">Explorer les produits →</a>
        </article>
        ...
        <article id="securite" class="rounded-2xl border border-emerald-300 bg-[#F3FBF6] p-5 shadow-sm relative overflow-hidden">
