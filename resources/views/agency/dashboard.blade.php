        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    <div
                        class="h-14 w-14 rounded-2xl bg-gradient-to-br from-[#00843D] to-[#006B32] text-white flex items-center justify-center font-black text-2xl shadow-md shadow-emerald-900/10 shrink-0">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-50 text-[#00843D] border border-emerald-200">
                                Partenaire Agréé
                            </span>
                        </div>
            ...
            @if (session('success'))
                <div
                    class="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3.5 rounded-xl mb-6 text-sm flex items-center gap-3 shadow-xs">
                    <span
                        class="flex h-7 w-7 items-center justify-center rounded-full bg-[#00843D] text-white text-xs font-bold">✓</span>
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 mb-8">
                <div class="flex items-center gap-2 mb-4">
                    <span
                        class="flex h-6 w-6 items-center justify-center rounded-full bg-[#00843D]/10 text-[#00843D] text-xs font-bold">+</span>
                ...
                @if ($agency->cities->where('is_active', true)->isEmpty())
                    <div
                        class="bg-amber-50 border border-amber-200 text-amber-800 rounded-xl p-4 text-sm flex items-center gap-3">
                ...
                @else
                    <form method="POST" action="{{ route('agency.counters.store') }}"
                        ...
                        <div class="md:col-span-2 lg:col-span-4 mt-2">
                            <button
                                class="w-full md:w-auto bg-[#00843D] hover:bg-[#006B32] text-white font-bold px-6 py-2.5 rounded-xl text-xs transition shadow-sm shadow-emerald-900/15">
                        ...
                        <div class="p-5">
                            ...
                            <div class="mt-4">
                                @if ($counter->secretary?->secretary)
                                    ...
                                    <div class="space-y-3" x-data="{ editing: false }">
                                        <div
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="h-9 w-9 rounded-full bg-emerald-100 text-[#00843D] font-black text-xs flex items-center justify-center">
                                            ...
                                            <div
                                                ...
                                                <span
                                                    class="text-[11px] font-bold px-2.5 py-0.5 rounded-md {{ $sec->isActive() ? 'bg-emerald-100 text-[#00843D]' : 'bg-amber-100 text-amber-700' }}">
                                                    {{ $sec->isActive() ? 'Opérationnel' : 'Suspendu' }}
                                                </span>

                                                <button type="button" @click="editing = !editing"
                                                    class="text-xs font-bold text-[#00843D] hover:underline">
                                        ...
                                        <div x-show="editing" x-cloak
                                            ...
                                            <form method="POST" action="{{ route('agency.secretary.update', $sec) }}"
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                    <div>
                                                        ...
                                                        <input type="text" name="name" required
                                                            value="{{ $sec->name }}"
                                                            class="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-xs font-semibold text-slate-800 focus:border-[#00843D] focus:ring-1 focus:ring-[#00843D]">
                                                    </div>
                                                    <div>
                                                        <label
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="password" name="password"
                                                            ...
                                                            class="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-xs font-semibold text-slate-800 placeholder-slate-400 focus:border-[#00843D] focus:ring-1 focus:ring-[#00843D]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex justify-end gap-2 pt-1">
                                                    ...
                                                    <button type="submit"
                                                        class="bg-[#00843D] hover:bg-[#006B32] text-white font-bold py-1.5 px-4 rounded-lg text-xs transition">
                                                        Enregistrer
                                                    </button>
                                                </div>
                                            </form>
                                ...
                                @else
                                    ...
                                    <div
                                        class="bg-amber-50/50 border border-dashed border-amber-300/80 rounded-xl p-4">
                                        <div class="flex items-center gap-2 mb-3 text-amber-800">
                                            <svg class="w-4 h-4 text-amber-600 shrink-0" fill="none"
                                        ...
                                        <form method="POST" action="{{ route('agency.secretary.store', $counter) }}"
                                            ...
                                            <button
                                                class="bg-[#00843D] hover:bg-[#006B32] text-white font-bold py-2 px-4 rounded-lg text-xs transition shadow-xs">
