            ...
            @foreach($conversations as $conv)
                ...
                <a href="{{ route('messaging.show', $conv) }}"
                   class="flex items-center gap-4 bg-white rounded-2xl border
                    ...
                    {{-- Avatar --}}
                    <div class="w-12 h-12 rounded-xl bg-indigo-50 text-indigo-600 font-bold
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between">
                            <p class="font-semibold text-gray-900 text-sm {{ $unread > 0 ? 'text-indigo-700' : '' }}">
                                {{ $partner }}
                            </p>
                            @if($last)
                        ...
                        <div class="flex items-center justify-between mt-0.5">
                            ...
                            @if($unread > 0)
                                <span class="bg-indigo-600 text-white text-xs font-bold
