    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-white py-5">
        ...
        <div class="max-w-5xl mx-auto px-4">
            ...
            <div class="grid lg:grid-cols-5 rounded-3xl overflow-hidden shadow-2xl bg-white">
                ...
                ======================================================= --}}
                <div
                    class="lg:col-span-2 relative overflow-hidden bg-gradient-to-br from-blue-900 via-blue-700 to-blue-600 text-white">
                    ...
                    <div
                        class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,.15),transparent_45%)]">
                    </div>
                    ...
                    <div class="relative z-10 flex flex-col justify-between h-full p-10">
                        ...
                        <div class="space-y-5 mt-12">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-12 h-12 rounded-2xl bg-white/15 backdrop-blur flex items-center justify-center text-xl">
                                    🔒
                                </div>
                                <div>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-blue-100">Pensée pour inspirer confiance dès la première
                                        visite.</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-3 p-8 lg:p-12">
                    ...
                    <form action="{{ route('register') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div
                                    class="relative rounded-2xl border border-slate-300 focus-within:border-blue-600 focus-within:ring-4 focus-within:ring-blue-100 transition">
                                    <svg class="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5.121 17.804A11.955 11.955 0 0112 15c2.5 0 4.82.76 6.879 2.056M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                    </svg>
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <svg class="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M16 12H8m8-4H8m10-3H6a2 2 0 00-2 2v10a2 2 0 002 h12a2 2 0 002-2V7a2 2 0 00-2-2z" />
                                    </svg>
                        ...
                        <div>
                            ...
                            <div
                                class="flex rounded-2xl border border-slate-300 overflow-hidden focus-within:border-blue-600 focus-within:ring-4 focus-within:ring-blue-100 transition">
                                <div class="px-5 flex items-center bg-slate-50 border-r text-slate-600 font-semibold">
                                    🇨🇲 +237
                                </div>
                                <input id="phone" type="text" name="phone" value="{{ old('phone') }}"
                                    placeholder="6 XX XX XX XX" class="flex-1 py-4 px-4 outline-none border-0">
                            </div>
                            @error('phone')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="grid md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <div
                                    class="relative rounded-2xl border border-slate-300 focus-within:border-blue-600 focus-within:ring-4 focus-within:ring-blue-100">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                ...
                                <!-- Acheteur -->
                                <label
                                    class="flex items-start gap-3 p-4 border border-slate-200 rounded-2xl cursor-pointer transition hover:border-blue-500 hover:bg-blue-50/40 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50 has-[:checked]:ring-2 has-[:checked]:ring-blue-600">
                        ...
                        {{-- Bouton Submit --}}
                        <button type="submit"
                            class="w-full rounded-2xl bg-gradient-to-r from-blue-700 to-blue-600 py-4 text-base font-bold text-white transition hover:from-blue-800 hover:to-blue-700 shadow-lg shadow-blue-200 mt-4">
                            Créer mon compte
                        </button>
                    ...
                    {{-- Lien Se connecter --}}
                    <div
                        class="mt-8 border-t border-slate-100 pt-6 text-center text-slate-600 flex items-center justify-center gap-2">
