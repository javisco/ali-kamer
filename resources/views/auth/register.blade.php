            ...
            <div class="bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden">
                ...
                <div class="bg-gradient-to-br from-blue-900 via-blue-700 to-blue-600 px-6 pt-8 pb-6 text-center relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-xs text-blue-100 mt-1">Rejoignez la plateforme Ali-Kamer dès aujourd'hui</p>
                    </div>
                </div>
                    ...
                    <form action="{{ route('register') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus
                                ...
                                @error('name') border-red-500 focus:ring-red-500 @else border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-100 @enderror
                                focus:outline-none">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-2xl border border-slate-200 overflow-hidden bg-slate-50/50 focus-within:border-blue-600 focus-within:ring-4 focus-within:ring-blue-100 transition">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="password" required placeholder="Minimum 8 caractères"
                                    ...
                                    focus:outline-none">
                                <button type="button" id="togglePassword" class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-blue-600 text-sm">
                                    👁
                                </button>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password_confirmation" id="password_confirmation" required placeholder="Confirmez le mot de passe"
                                    class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 pr-12 text-sm transition bg-slate-50/50 focus:border-blue-600 focus:ring-4 focus:ring-blue-100 focus:outline-none">
                                <button type="button" id="togglePasswordConfirmation" class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-blue-600 text-sm">
                                    👁
                                </button>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-3 pt-1">
                                <label class="flex items-center gap-2.5 p-3.5 border border-slate-200 rounded-2xl cursor-pointer bg-slate-50/50 transition hover:border-blue-500 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50/60 has-[:checked]:ring-2 has-[:checked]:ring-blue-600">
                                    <input type="radio" name="role" value="buyer" class="h-4 w-4 text-blue-600 focus:ring-blue-500 cursor-pointer" {{ old('role', 'buyer') == 'buyer' ? 'checked' : '' }}>
                                    <span class="text-xs font-bold text-slate-700">Acheteur</span>
                                </label>

                                <label class="flex items-center gap-2.5 p-3.5 border border-slate-200 rounded-2xl cursor-pointer bg-slate-50/50 transition hover:border-blue-500 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50/60 has-[:checked]:ring-2 has-[:checked]:ring-blue-600">
                                    <input type="radio" name="role" value="seller" class="h-4 w-4 text-blue-600 focus:ring-blue-500 cursor-pointer" {{ old('role') == 'seller' ? 'checked' : '' }}>
                        ...
                        <!-- Bouton Submit -->
                        <button type="submit"
                            class="w-full rounded-2xl bg-gradient-to-r from-blue-700 to-blue-600 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-200 transition hover:from-blue-800 hover:to-blue-700 active:scale-[0.99] mt-3">
                            Créer mon compte
                        </button>
                    </form>
