    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-lg">
            ...
            <div class="bg-white shadow-xl rounded-3xl overflow-hidden border border-slate-100">
                ...
                <div class="bg-gradient-to-br from-primary-800 via-primary-600 to-[#046A38] text-white px-8 py-8 relative overflow-hidden text-center">
                    ...
                    <div class="relative z-10 flex flex-col items-center">
                        ...
                        <p class="mt-2 text-success-100/90 text-xs sm:text-sm max-w-xs leading-relaxed">
                ...
                <div class="p-6 sm:p-8 space-y-6">
                    ...
                    <!-- Alerte Succès -->
                    @if(session('message'))
                        <div class="rounded-2xl border border-success-200 bg-success-50 p-4 text-xs sm:text-sm text-success-700 font-medium flex items-center gap-3">
                    ...
                    <div class="rounded-2xl border border-warning-200 bg-warning-50/60 p-5">
                        <h2 class="font-bold text-warning-800 text-xs flex items-center gap-2 mb-2">
                            <span>💡</span> Vous ne trouvez pas l'e-mail ?
                        </h2>
                        <ul class="list-disc pl-5 space-y-1 text-[11px] sm:text-xs text-warning-800/80 leading-relaxed">
