                        ...
                        <td class="px-5 py-4">
                            @php
                                $roleConfig = [
                                    ...
                                    'seller'    => ['label' => 'Vendeur',     'class' => 'bg-indigo-100 text-indigo-700'],
                                    'secretary' => ['label' => 'Secrétaire',  'class' => 'bg-purple-100 text-purple-700'],
                        ...
                        <td class="px-5 py-4">
                            @php
                                $statusConfig = [
                                    ...
                                    'candidate' => ['label' => 'Candidat',   'class' => 'bg-yellow-100 text-yellow-700'],
                                    'suspended' => ['label' => 'Suspendu',   'class' => 'bg-orange-100 text-orange-700'],
                                    'banned'    => ['label' => 'Banni',      'class' => 'bg-red-100 text-red-700'],
                                ];
                                $sc = $statusConfig[$user->status] ?? ['label' => $user->status, 'class' => 'bg-gray-100 text-gray-600'];
                            @endphp
                                            ...
                                            <form method="POST"
                                                ...
                                                <input type="text" name="reason" required
                                                       ...
                                                       class="flex-1 border border-gray-300 rounded-lg
                                                              px-2 py-1 text-xs">
                                                <button class="bg-red-600 text-white text-xs
