...
<div class="max-w-4xl mx-auto px-4">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.disputes.index') }}"
           class="text-sm text-indigo-600 hover:underline">← Retour</a>
    </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold">{{ number_format($dispute->order->total_amount, 0, ',', ' ') }} FCFA</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Montant net vendeur</span>
                        <span class="font-bold">{{ number_format($dispute->order->net_amount, 0, ',', ' ') }} FCFA</span>
                    </div>
                </div>
            </div>
                            ...
                            <div class="p-4 bg-gray-50 rounded-xl">
                                ...
                                @elseif($evidence->isPhoto())
                                    <img src="{{ asset('storage/' . $evidence->url) }}"
                                         class="rounded-xl max-w-sm cursor-pointer"
                                         onclick="window.open(this.src)">
                                @else
                                    <a href="{{ asset('storage/' . $evidence->url) }}"
                                       target="_blank" class="text-indigo-600 hover:underline text-sm">
