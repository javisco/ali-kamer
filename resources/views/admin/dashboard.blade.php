...
@section('content')
    ...
    {{-- =========================================================
     ALI-KAMER ADMIN — DESIGN SYSTEM
     Identité : bleu Ali-Kamer + surfaces neutres
========================================================= --}}
    <div class="min-h-screen bg-[#F7F8FA]">
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    text-slate-200 text-[11px] font-semibold mb-2">
                                ...
                                {{-- Seul élément volontairement plus grand : titre de page --}}
                                <h1 class="text-2xl sm:text-3xl font-black tracking-tight text-white">
                                    Tableau de bord
                                </h1>

                                <p class="mt-1.5 text-xs sm:text-sm text-slate-200 max-w-2xl">
                                    ...
                                    <div class="relative">
                                        ...
                                        <span
                                            class="absolute inset-0 rounded-full
                                             bg-emerald-400 animate-ping opacity-50"></span>
        ...
        ========================================================== --}}
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 mb-5">
                    ...
                    <div
                        ...
                        shadow-[0_2px_12px_rgba(15,23,42,0.05)] hover:shadow-lg hover:-translate-y-0.5
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div>
                                    ...
                                    <p class="text-[11px] font-bold uppercase tracking-wider text-[#94A3B8]">
                                        Commandes aujourd'hui
                                    </p>

                                    <p class="text-2xl font-black text-[#0F172A] mt-1.5">
                                        {{ $kpis['orders_today'] }}
                                    </p>
                                ...
                                <div
                                    ...
                                    shadow-[0_8px_24px_rgba(15,23,42,0.08)] shadow-blue-100
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p
                                      ...
                                      text-[#1769E0] mt-1.5 truncate">

                                        {{ number_format($kpis['revenue_today'], 0, ',', ' ') }}

                                        <span class="text-[11px] font-bold text-blue-500">
                                            FCFA
                                        </span>
                    ...
                    <div
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                {{ $kpis['disputes_open'] > 0 ? 'text-red-600' : 'text-[#0F172A]' }}">
                                    ...
                                    @if ($kpis['disputes_open'] > 0)
                                        <a href="{{ route('admin.disputes.index') }}"
                                            class="inline-flex items-center gap-1 mt-1.5
                                    ...
                                    @else
                                        <p class="mt-1.5 text-[11px] text-emerald-600 font-medium">
                                ...
                                <div
                                    ...
                                    group-hover:scale-110 transition-transform
                                    {{ $kpis['disputes_open'] > 0
                                        ? 'bg-gradient-to-br from-red-500 to-rose-600 text-white shadow-[0_8px_24px_rgba(15,23,42,0.08)] shadow-red-200'
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div>
                                    ...
                                    <p
                                        class="text-2xl font-black mt-1.5
                                {{ $kpis['kyc_pending'] > 0 ? 'text-orange-600' : 'text-[#0F172A]' }}">
                                ...
                                <div
                                    ...
                                    group-hover:scale-110 transition-transform
                                    {{ $kpis['kyc_pending'] > 0
                                        ? 'bg-gradient-to-br from-orange-400 to-amber-500 text-white shadow-[0_8px_24px_rgba(15,23,42,0.08)] shadow-orange-200'
                                        : 'bg-emerald-50 text-emerald-600' }}">
        ...
        ========================================================== --}}
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
                    ...
                    <div
                        ...
                        <div
                            class="absolute -right-14 -top-14 w-40 h-40
                            rounded-full bg-[#EEF5FF]0/10 blur-2xl">
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mb-1.5">
                                        ...
                                        <div
                                            class="w-7 h-7 rounded-xl bg-white/10
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mb-1.5">
                                        ...
                                        <div
                                            class="w-7 h-7 rounded-xl bg-white/15
                                            text-white flex items-center justify-center">
                                        ...
                                        <span class="text-[11px] font-bold uppercase tracking-wider text-blue-50">
                                            Disponible
                                        </span>
                                ...
                                <div
                                    ...
                                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-10v1m0 10v1" />
                ...
                @if ($campayBalance)
                    <div
                        class="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_12px_rgba(15,23,42,0.05)] p-5 mb-6">
                        <h2 class="font-bold text-gray-800 mb-4">💳 Solde Campay plateforme</h2>
                        <div class="grid grid-cols-3 gap-4">
                            <div class="bg-[#F7F8FA] rounded-2xl p-4">
                                <p class="text-xs text-[#64748B] mb-1">MTN MoMo</p>
                                <p class="text-xl font-extrabold text-[#172033]">
                                    {{ number_format($campayBalance['mtn'] ?? 0, 0, ',', ' ') }} FCFA
                                </p>
                            </div>
                            <div class="bg-[#F7F8FA] rounded-2xl p-4">
                                <p class="text-xs text-[#64748B] mb-1">Orange Money</p>
                                <p class="text-xl font-extrabold text-[#172033]">
                                    {{ number_format($campayBalance['orange'] ?? 0, 0, ',', ' ') }} FCFA
                                </p>
                            </div>
                            <div class="bg-[#F7F8FA] rounded-2xl p-4">
                                <p class="text-xs text-[#64748B] mb-1">Solde Total</p>
                                <p class="text-xl font-extrabold text-[#172033]">
                                    {{ number_format($campayBalance['total_balance'] ?? 0, 0, ',', ' ') }} FCFA
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        ========================================================== --}}
                ...
                <div class="mb-5">
                    ...
                    <div class="flex items-end justify-between mb-3">
                        ...
                        <div>
                            <p class="text-[11px] font-bold uppercase tracking-wider text-[#1769E0]">
                                Navigation
                            </p>

                            <h2 class="text-lg font-black text-[#0F172A] mt-0.5">
                                Accès rapides
                            </h2>

                            <p class="text-xs text-[#64748B] mt-0.5">
                                Accédez directement aux principaux outils d'administration.
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                        ...
                        <a href="{{ route('admin.users.index') }}"
                            class="group relative overflow-hidden bg-white
                          border border-slate-200/80 rounded-2xl p-4
                          shadow-[0_2px_12px_rgba(15,23,42,0.05)] hover:shadow-lg hover:-translate-y-0.5
                          transition-all duration-300">
                            ...
                            <div
                                ...
                                flex items-center justify-center
                                group-hover:bg-[#1769E0] group-hover:text-white
                                transition-all duration-300">
                        ...
                        <a href="{{ route('admin.kyc.index') }}"
                          ...
                          transition-all duration-300">
                            ...
                            <div
                                class="w-10 h-10 rounded-2xl
                                bg-[#F7F8FA] text-orange-600
                                flex items-center justify-center
                                group-hover:bg-[#F7F8FA]0 group-hover:text-white
                                transition-all duration-300">
        ...
        ========================================================== --}}
            ...
            ====================================================== --}}
                    ...
                    <div
                        class="bg-white border border-slate-200/80 rounded-2xl
                        shadow-[0_2px_12px_rgba(15,23,42,0.05)] overflow-hidden">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        ...
                                        <h2 class="text-sm font-black text-[#172033]">
                                            KYC à valider
                                        </h2>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2.5 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-xs font-bold text-[#172033] truncate">
                                            {{ $kyc->user->name }}
                                        </p>
                                ...
                                <a href="{{ route('admin.kyc.show', $kyc) }}"
                                  ...
                                  bg-[#F7F8FA] text-orange-600
                                  text-[11px] font-bold
                                  hover:bg-[#F7F8FA]0 hover:text-white
                                  transition">
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2.5 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-[11px] text-[#94A3B8] mt-0.5 truncate">
                                            {{ $dispute->typeLabel() }}
                                            ·
                    ...
                    <div class="px-4 sm:px-5 py-4 border-b border-slate-100">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-[#94A3B8] mt-1.5 ml-10">
                    ...
                    <div class="hidden md:block overflow-x-auto">
                        ...
                        <table class="w-full">
                            ...
                            <thead>
                                ...
                                <tr class="bg-[#F7F8FA]/80 border-b border-slate-100">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ...
                                @forelse($recentOrders as $order)
                                    @php
                                        ...
                                        $statusStyles = [
                                            'pending' => 'bg-slate-100 text-[#475569] ring-slate-200',
                                            'awaiting_payment' => 'bg-[#F7F8FA] text-[#64748B] ring-yellow-200',
                                            'paid' => 'bg-emerald-50 text-emerald-700 ring-emerald-200',
                                            'preparing' => 'bg-[#EEF5FF] text-[#1258C4] ring-blue-200',
                                            'registered_origin' => 'bg-[#EEF5FF] text-indigo-700 ring-indigo-200',
                                            'in_transit' => 'bg-purple-50 text-purple-700 ring-purple-200',
                                            'arrived_destination' => 'bg-[#EEF5FF] text-cyan-700 ring-cyan-200',
                                            'awaiting_buyer_confirmation' =>
                                                'bg-[#F7F8FA] text-[#64748B] ring-orange-200',
                                        ...
                                        $statusDots = [
                                            ...
                                            'awaiting_payment' => 'bg-[#F7F8FA]0',
                                            'paid' => 'bg-emerald-500',
                                            'preparing' => 'bg-[#EEF5FF]0',
                                            'registered_origin' => 'bg-[#EEF5FF]0',
                                            'in_transit' => 'bg-purple-500',
                                            'arrived_destination' => 'bg-[#EEF5FF]0',
                                            'awaiting_buyer_confirmation' => 'bg-[#F7F8FA]0',
                                    ...
                                    <tr class="group hover:bg-[#EEF5FF]/30 transition-colors">
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            <div class="flex items-center gap-2.5">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-xs font-bold text-[#172033]">
                                                        {{ $order->reference }}
                                                    </p>
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            <p class="text-xs font-medium text-[#334155]">
                                                {{ $order->buyer->name }}
                                            </p>
                                        ...
                                        <td class="px-4 py-3 text-right">
                                            ...
                                            <p class="text-xs font-black text-[#172033]">
                                        ...
                                        <td class="px-4 py-3 text-right">
                                            ...
                                            <span
                                             ...
                                             text-[10px] font-bold
                                             ring-1 ring-inset
                                             {{ $statusStyles[$order->status] ?? 'bg-slate-100 text-[#475569] ring-slate-200' }}">
                                            ...
                                            flex items-center justify-center mb-3">
                                                ...
                                                <svg class="w-6 h-6" fill="none" stroke="currentColor"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="1.8" d="M9 5h6M9 9h6m-8 4h10m-8 4h6" />
                    ...
                    <div class="md:hidden divide-y divide-slate-100">
                        ...
                        @forelse($recentOrders as $order)
                            @php
                                ...
                                $statusStyles = [
                                    'pending' => 'bg-slate-100 text-[#475569]',
                                    'awaiting_payment' => 'bg-[#F7F8FA] text-[#64748B]',
                                    'paid' => 'bg-emerald-50 text-emerald-700',
                                    'preparing' => 'bg-[#EEF5FF] text-[#1258C4]',
                                    'registered_origin' => 'bg-[#EEF5FF] text-indigo-700',
                                    'in_transit' => 'bg-purple-50 text-purple-700',
                                    'arrived_destination' => 'bg-[#EEF5FF] text-cyan-700',
                                    'awaiting_buyer_confirmation' => 'bg-[#F7F8FA] text-[#64748B]',
                            ...
                            <div class="p-4 hover:bg-[#F7F8FA] transition">
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        {{ in_array($order->status, ['completed', 'auto_completed', 'paid'])
                                            ...
                                            <p class="text-sm font-black text-[#172033] truncate">
                                                {{ $order->reference }}
                                            </p>
                                    ...
                                    <span
                                        class="inline-flex flex-shrink-0
                                         ...
                                         text-[10px] font-bold
                                         {{ $statusStyles[$order->status] ?? 'bg-slate-100 text-[#475569]' }}">
                                ...
                                <div class="flex items-center justify-between mt-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[11px] font-semibold text-[#475569] mt-0.5">
                                            {{ $order->shop->name }}
                                        </p>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-xs font-black text-[#172033] mt-0.5">
                        ...
                        @empty
                            ...
                            <div class="px-5 py-12 text-center">
                                ...
                                <p class="text-sm font-bold text-[#475569]">
                                    Aucune commande récente
                                </p>
