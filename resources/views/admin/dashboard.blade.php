...
<div class="min-h-screen bg-[#F7F8FA]">
    ...
    <div class="min-h-screen bg-[#F7F8FA]">
        ...
        ========================================================== --}}
            ...
            {{-- Solde Campay --}}
            @if ($campayBalance)
                <div class="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_12px_rgba(15,23,42,0.05)] p-5 mb-6">
        ...
        ========================================================== --}}
            ...
            ====================================================== --}}
                ...
                <div class="bg-white border border-slate-200/80 rounded-2xl
                            ...
                            @forelse($recentOrders as $order)
                                @php
                                    ...
                                    $statusStyles = [
                                        ...
                                        'awaiting_buyer_confirmation' => 'bg-[#F7F8FA] text-[#64748B] ring-orange-200',
