        ...
        ========================================================== --}}
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-7">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div
                        class="hidden sm:flex items-center gap-2 px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm text-slate-600 shadow-sm">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4">
                ...
                <div class="bg-white border border-slate-200 rounded-xl p-4 sm:p-5 shadow-sm">
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div
                            class="w-9 h-9 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center flex-shrink-0">
                ...
                <div class="bg-white border border-slate-200 rounded-xl p-4 sm:p-5 shadow-sm">
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div>
                            ...
                            <p
                                class="text-2xl sm:text-3xl font-bold mt-2
        ...
        ========================================================== --}}
            ...
            <div class="bg-white border border-slate-200 rounded-xl shadow-sm mb-7">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 divide-x divide-y sm:divide-y-0 divide-slate-100">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="p-4 hover:bg-slate-50 transition group">

                        <div class="flex items-center gap-3">

                            <div
                                class="w-9 h-9 rounded-lg bg-slate-100 text-slate-600 flex items-center justify-center group-hover:bg-indigo-50 group-hover:text-indigo-600 transition">
                    ...
                    <a href="{{ route('admin.agencies.index') }}" class="p-4 hover:bg-slate-50 transition group">
                    ...
                    <a href="{{ route('admin.kyc.index') }}" class="p-4 hover:bg-slate-50 transition group">

                        <div class="flex items-center gap-3">

                            <div
                                class="w-9 h-9 rounded-lg bg-slate-100 text-slate-600 flex items-center justify-center group-hover:bg-orange-50 group-hover:text-orange-600 transition">
                    ...
                    <a href="{{ route('admin.disputes.index') }}" class="p-4 hover:bg-slate-50 transition group">

                        <div class="flex items-center gap-3">

                            <div
                                class="w-9 h-9 rounded-lg bg-slate-100 text-slate-600 flex items-center justify-center group-hover:bg-red-50 group-hover:text-red-600 transition">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-7">
                ...
                <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
                    ...
                    @forelse($pendingKyc as $kyc)
                        <div
                            class="flex items-center justify-between gap-4 px-5 py-3.5 border-b border-slate-50 last:border-0">
                    ...
                    @empty
                        ...
                        <div class="px-5 py-10 text-center">
                            ...
                            <div
                                class="mx-auto w-10 h-10 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center mb-3">
                                ✓
                            </div>
                    ...
                    <table class="w-full">
                        ...
                        <thead class="bg-slate-50 border-b border-slate-100">
                            ...
                            <tr>
                                ...
                                <th
                                    class="text-left px-5 py-3 text-[11px] font-semibold uppercase tracking-wider text-slate-500">
                                    Commande
                                </th>
                                ...
                                <th
                                    class="text-right px-5 py-3 text-[11px] font-semibold uppercase tracking-wider text-slate-500">
                                    Montant
                                </th>
                    ...
                    @forelse($recentOrders as $order)
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <span
                                    class="inline-flex px-2 py-1 rounded-full text-[10px] font-semibold
                                {{ $statusStyles[$order->status] ?? 'bg-slate-100 text-slate-600' }}">
