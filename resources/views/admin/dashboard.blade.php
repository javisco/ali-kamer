    ...
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6">
            ...
            <div class="relative px-5 sm:px-6 py-5 sm:py-6">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div>
                        ...
                        <div class="inline-flex items-center gap-2 px-2.5 py-1
                                    rounded-full bg-white/10 border border-white/20
                                    text-indigo-100 text-[11px] font-semibold mb-2">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <div class="inline-flex items-center gap-2.5
                            ...
                            <div class="relative">
                                ...
                                <span class="relative block w-2.5 h-2.5 rounded-full
                                             bg-emerald-400"></span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 mb-5">
            ...
            <div class="group relative overflow-hidden bg-white
                ...
                <div class="absolute inset-x-0 top-0 h-1
                            bg-gradient-to-r from-indigo-500 to-blue-500"></div>
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-black text-slate-900 mt-1.5">
                                {{ $kpis['orders_today'] }}
                            </p>
            ...
            <div class="group relative overflow-hidden bg-white
                ...
                <div class="absolute inset-x-0 top-0 h-1
                            bg-gradient-to-r from-violet-500 to-fuchsia-500"></div>
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xl sm:text-2xl font-black
                                      text-violet-600 mt-1.5 truncate">

                                {{ number_format($kpis['revenue_today'], 0, ',', ' ') }}

                                <span class="text-[11px] font-bold text-violet-500">
                                    FCFA
                                </span>
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div class="w-10 h-10 rounded-xl
                                    ...
                                    group-hover:scale-110 transition-transform
                                    {{ $kpis['disputes_open'] > 0
                                        ? 'bg-gradient-to-br from-red-500 to-rose-600 text-white shadow-md shadow-red-200'
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
            ...
            <div class="relative overflow-hidden rounded-xl
                ...
                <div class="absolute -right-14 -top-14 w-40 h-40
                            rounded-full bg-indigo-500/20 blur-2xl"></div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 mb-1.5">
                                ...
                                <div class="w-7 h-7 rounded-lg bg-white/10
                                            text-indigo-300 flex items-center justify-center">
                        ...
                        <div class="hidden sm:flex w-12 h-12 rounded-xl
            ...
            <div class="relative overflow-hidden rounded-xl
                ...
                <div class="absolute -right-14 -top-14 w-40 h-40
                            rounded-full bg-white/10 blur-2xl"></div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 mb-1.5">
                                ...
                                <div class="w-7 h-7 rounded-lg bg-white/15
                                            text-white flex items-center justify-center">
                                ...
                                <span class="text-[11px] font-bold uppercase tracking-wider text-emerald-50">
                                    Disponible
                                </span>
                ...
                <a href="{{ route('admin.users.index') }}"
                   class="group relative overflow-hidden bg-white
                    ...
                    <div class="absolute inset-x-0 bottom-0 h-1
                                ...
                                origin-left transition-transform"></div>
                    ...
                    @forelse($recentOrders as $order)
                        ...
                        @php
                            ...
                            $statusStyles = [
                                ...
                                'awaiting_payment' => 'bg-yellow-50 text-yellow-700 ring-yellow-200',
                    ...
                    @empty
                        ...
                        <tr>
                            ...
                            <td colspan="5" class="px-4 py-14 text-center">
                                ...
                                <div class="mx-auto w-14 h-14 rounded-xl
