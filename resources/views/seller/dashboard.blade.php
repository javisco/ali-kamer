...
@section('content')
    ...
    <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8 bg-slate-50 min-h-screen">
        ...
        <div class="animate-fade-in space-y-6">
            ...
            <div
                class="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white rounded-3xl p-6 sm:p-8 shadow-xl">
                ...
                <div class="absolute left-1/3 -top-12 w-40 h-40 bg-indigo-400/20 rounded-full blur-xl pointer-events-none">
                </div>

                <div class="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
                    <div>
                        <div
                            class="inline-flex items-center gap-2 bg-white/15 backdrop-blur-md px-3 py-1 rounded-full text-xs font-semibold text-white mb-3 border border-white/20">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                ...
                <div
                    class="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm hover:border-blue-300 transition-all">
                ...
                <div
                    class="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm hover:border-emerald-300 transition-all">
                    <div class="flex items-center justify-between mb-2">
                ...
                <!-- Card 3 : Localisation -->
                <div
                    class="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm hover:border-amber-300 transition-all">
                    <div class="flex items-center justify-between mb-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <a href="{{ route('seller.products.index') }}"
                        ...
                        <div class="flex items-center gap-3.5">
                            <div
                                class="w-11 h-11 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-colors">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <h3 class="text-sm font-bold text-slate-800 group-hover:text-blue-600 transition-colors">Mes
                                    Produits</h3>
                                <p class="text-xs text-slate-400">Ajouter, modifier ou masquer</p>
                            </div>
                        </div>
                        <svg class="w-4 h-4 text-slate-300 group-hover:text-blue-600 transform group-hover:translate-x-1 transition-all"
                    ...
                    <a href="{{ route('seller.orders.index') }}"
                        ...
                        <div class="flex items-center gap-3.5">
                            <div
                                class="w-11 h-11 rounded-xl bg-orange-50 text-orange-600 flex items-center justify-center group-hover:bg-orange-600 group-hover:text-white transition-colors">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <h3 class="text-sm font-bold text-slate-800 group-hover:text-orange-600 transition-colors">
                                    Mes Commandes</h3>
                                <p class="text-xs text-slate-400">Traiter et expédier les colis</p>
                            </div>
                        </div>
                        <svg class="w-4 h-4 text-slate-300 group-hover:text-orange-600 transform group-hover:translate-x-1 transition-all"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    </a>
                    ...
                    <a href="{{ route('seller.wallet.index') }}"
                        ...
                        <div class="flex items-center gap-3.5">
                            <div
                                class="w-11 h-11 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <h3
                                    class="text-sm font-bold text-slate-800 group-hover:text-emerald-600 transition-colors">
                                    Mon Portefeuille</h3>
                                <p class="text-xs text-slate-400">Solde disponible & retraits</p>
                            </div>
                        </div>
                        <svg class="w-4 h-4 text-slate-300 group-hover:text-emerald-600 transform group-hover:translate-x-1 transition-all"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    </a>
                        ...
                        <div class="flex items-center gap-3.5">
                            ...
                            <div>
                                <h3
                                    class="text-sm font-bold text-slate-800 group-hover:text-emerald-600 transition-colors">
                                    MES Transactions</h3>
                                <p class="text-xs text-slate-400">Toutes mes transactions depuis la creation de mon compte</p>
                            </div>
                        </div>
                        <svg class="w-4 h-4 text-slate-300 group-hover:text-emerald-600 transform group-hover:translate-x-1 transition-all"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
