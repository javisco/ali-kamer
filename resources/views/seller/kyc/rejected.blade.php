    ...
    <div class="w-full max-w-5xl h-full max-h-[640px] bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-slate-200/80">
        ...
        <div class="w-full lg:w-7/12 h-full p-5 sm:p-6 lg:p-8 flex flex-col justify-between overflow-hidden">
            ...
            <div class="flex items-center justify-between shrink-0">
                ...
                <span class="inline-flex items-center gap-1.5 text-[10px] font-black tracking-widest text-[#EA2328] bg-[#EA2328]/10 px-3 py-1 rounded-full uppercase border border-[#EA2328]/30">
            ...
            <!-- Flash Session Fail -->
            @if (session('fail'))
                <div class="my-1 rounded-xl border border-red-200 bg-red-50 p-2.5 text-xs text-red-700 font-medium">
                    {{ session('fail') }}
                </div>
            @endif
            ...
            <div class="my-auto space-y-3.5">
                ...
                <!-- Header Statut Rejet -->
                <div class="rounded-2xl bg-gradient-to-br from-red-500/10 via-red-50/50 to-slate-50 p-3.5 border border-[#EA2328]/30 flex items-center gap-3.5">
                    <div class="w-12 h-12 rounded-2xl bg-[#EA2328]/15 flex items-center justify-center text-2xl shrink-0 shadow-inner">
                        ⚠️
                    </div>
                    <div>
                ...
                <div class="rounded-2xl border border-red-200 bg-red-50/60 p-3.5 space-y-1.5">
                    <h2 class="text-[10px] font-black uppercase tracking-wider text-[#EA2328] flex items-center gap-1.5">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                        </svg>
                        Motif du rejet communiqué
                    </h2>
                    <p class="text-xs font-semibold text-slate-800 leading-relaxed bg-white/80 p-2.5 rounded-xl border border-red-100 shadow-sm">
                ...
                <div class="pt-1">
                    <a href="{{ route('seller.kyc.create') }}"
                       class="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-[#006837] hover:bg-[#00522b] px-6 py-3 text-xs font-black uppercase tracking-wider text-white shadow-lg shadow-[#006837]/20 transition-all active:scale-[0.98]">
        ...
        <div class="hidden lg:flex w-5/12 h-full bg-gradient-to-br from-[#8B0000] via-[#EA2328] to-[#004d28] text-white p-7 flex-col justify-between relative overflow-hidden shrink-0">
            ...
            <div class="absolute -bottom-16 -left-16 w-64 h-64 rounded-full bg-[#006837]/30 blur-3xl pointer-events-none"></div>
            ...
            <div class="relative z-10">
                <span class="inline-flex items-center gap-1.5 text-[10px] font-black tracking-widest uppercase text-[#FFC20E] bg-black/20 px-3 py-1 rounded-full backdrop-blur-md border border-[#FFC20E]/30">
                    <span class="w-1.5 h-1.5 rounded-full bg-[#FFC20E]"></span>
                    Support Vendeur
                </span>

                <h2 class="text-2xl font-black mt-5 leading-tight tracking-tight">
                    Besoin d'aide pour <br>votre <span class="text-[#FFC20E]">document ?</span>
                </h2>
                <p class="text-xs text-red-100/90 mt-2 leading-relaxed font-normal">
            ...
            <div class="relative z-10 space-y-2.5 my-auto">
                ...
                <div class="p-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/15 flex items-center gap-3">
                    <div class="w-7 h-7 rounded-lg bg-black/30 text-[#FFC20E] flex items-center justify-center text-xs font-bold shrink-0 shadow">
                        1
                    </div>
                    <div>
                        <h3 class="text-xs font-bold text-white">Lisez attentivement le motif</h3>
                        <p class="text-[10px] text-red-100/80">Identifiez la pièce à corriger.</p>
                    </div>
                </div>
                ...
                <div class="p-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/15 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-red-100/80">Évitez les reflets et les flous.</p>
                    </div>
                </div>

                <div class="p-3 rounded-xl bg-black/20 backdrop-blur-md border border-[#006837]/40 flex items-center gap-3 shadow-lg">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-emerald-100/90">Traitement prioritaire garanti.</p>
                    </div>
                </div>
            ...
            <div class="relative z-10 pt-3 border-t border-white/15 flex items-center justify-between text-xs">
                <div>
                    <p class="text-[10px] text-red-100/80 font-medium">Contacter le support</p>
