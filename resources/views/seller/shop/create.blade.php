            ...
            <div class="bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-sm">
                ...
                @if ($errors->any())
                    <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3.5 rounded-2xl mb-6 text-sm">
                        ...
                        <ul class="list-disc list-inside space-y-1 text-xs pl-1 text-red-600">
                ...
                <form method="POST" action="{{ route('seller.shop.store') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required
                            ...
                            class="w-full bg-slate-50 border @error('name') border-red-400 bg-red-50/30 @else border-slate-200 @enderror rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition">
                        @error('name')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="city" name="city" value="{{ old('city') }}" required
                                ...
                                class="w-full bg-slate-50 border @error('city') border-red-400 bg-red-50/30 @else border-slate-200 @enderror rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition">
                            @error('city')
                                <p class="text-xs text-red-500 mt-1 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" required
                                ...
                                class="w-full bg-slate-50 border @error('phone') border-red-400 bg-red-50/30 @else border-slate-200 @enderror rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition">
                            @error('phone')
                                <p class="text-xs text-red-500 mt-1 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="address" name="address" value="{{ old('address') }}"
                            ...
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                            ...
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition resize-none">{{ old('description') }}</textarea>
                    </div>

                    <!-- Bouton de Soumission -->
                    <div class="pt-2">
                        <button type="submit"
                            class="w-full inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 active:scale-[0.99] text-white font-bold py-3.5 px-6 rounded-xl text-sm shadow-lg shadow-blue-600/25 transition-all duration-200">
