...
@section('content')
    <div class="bg-gray-50 min-h-screen py-8">
        <div class="max-w-3xl mx-auto px-4">
            ...
            @endif
            {{-- Note explicative pour le vendeur --}}
            <div class="bg-emerald-50 border border-emerald-100 rounded-xl p-4 mb-6 text-sm">
                <p class="font-bold text-emerald-800 mb-1">
                    ✅ Vous recevez exactement le montant affiché
                </p>
                <p class="text-emerald-700 text-xs">
                    Les frais de virement Mobile Money sont pris en charge par la plateforme.
                    Le montant affiché dans votre portefeuille est exactement
                    ce que vous recevrez sur votre téléphone lors du retrait.
                </p>
            </div>
            {{-- Soldes --}}
