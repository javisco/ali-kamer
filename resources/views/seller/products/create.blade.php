    ...
    <div class="min-h-screen bg-[#F7F7F2] py-6 sm:py-8">
        <div class="w-full max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="bg-[#016837] text-white text-center py-6 px-4 relative">
                    ...
                    <p class="text-[#F9A01B] font-medium text-xs sm:text-sm mt-1">Ajouter un nouveau produit à votre catalogue</p>
                </div>

                {{-- Messages d'erreurs (Rouge) --}}
                @if ($errors->any())
                    <div class="m-6 p-4 rounded-2xl bg-[#E30613]/10 border border-[#E30613]/20 text-[#E30613] text-sm font-medium">
                ...
                <form method="POST" action="{{ route('seller.products.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-bold text-[#0a1b12] mb-1.5">
                                Titre du produit <span class="text-[#E30613]">*</span>
                            </label>
                            ...
                            <p class="text-xs text-gray-400 mt-1">Saisissez un titre clair (entre 10 et 80 caractères)</p>
                        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <label
                                ...
                                {{ old('shipping_included') == '1' ? 'border-[#016837] bg-[#016837]/5' : 'border-gray-200 hover:border-gray-300' }}">
                                ...
                                <div class="ml-3">
                                    <span class="block text-sm font-bold text-[#0a1b12]">Transport inclus</span>
                                    <span class="block text-xs text-gray-500">Inclus dans le prix du produit</span>
                                </div>
                            </label>

                            <label
                                class="relative flex items-center p-4 border-2 rounded-2xl cursor-pointer transition
                                {{ old('shipping_included', '0') == '0' ? 'border-[#016837] bg-[#016837]/5' : 'border-gray-200 hover:border-gray-300' }}">
                                <input type="radio" name="shipping_included" value="0"
                                    class="w-4 h-4 text-[#016837] focus:ring-[#016837]"
                                    {{ old('shipping_included', '0') == '0' ? 'checked' : '' }}>
                                <div class="ml-3">
                                    <span class="block text-sm font-bold text-[#0a1b12]">Transport exclu</span>
                        ...
                        <div class="pt-1">
                            ...
                            <input type="number" name="shipping_threshold_qty" value="{{ old('shipping_threshold_qty') }}"
                                ...
                                class="w-36 bg-[#F7F7F2]/60 border border-gray-200 rounded-xl px-3.5 py-2 text-sm text-[#0a1b12] font-medium focus:bg-white focus:border-[#016837] focus:ring-1 focus:ring-[#016837] transition outline-none">
                        </div>
                    </div>
                    ...
                    {{-- 5. Upload Photos --}}
                    <div>
                        <label class="block text-sm font-bold text-[#0a1b12] mb-1">
                            Photos du produit <span class="text-[#E30613]">*</span>
                        </label>
                        <p class="text-xs text-gray-500 mb-2">
                            Sélectionnez entre 1 et 5 photos (Max 2 MB par photo). La première sera la photo principale.
                        </p>
                        <input type="file" name="images[]" accept="image/*" multiple required
                            class="w-full bg-[#F7F7F2]/60 border border-gray-200 rounded-xl p-3 text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-xs file:font-bold file:bg-[#016837] file:text-white hover:file:bg-[#0a542d] cursor-pointer transition">
                    </div>

                    {{-- Boutons d'action --}}
                    <div class="pt-4 space-y-3">
                        <button type="submit"
                            class="w-full bg-[#016837] hover:bg-[#0a542d] text-white font-extrabold py-3.5 rounded-2xl shadow-md hover:shadow-lg transition flex items-center justify-center gap-2 text-sm">
                            <span>Créer le produit</span>
                            <span class="text-[#F9A01B] font-black">→</span>
                        </button>

                        <a href="{{ route('seller.products.index') }}"
                            class="block text-center w-full py-2 text-sm font-bold text-gray-400 hover:text-[#E30613] transition">
                            Annuler
                        </a>
                    </div>
