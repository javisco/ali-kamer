...
<head>
    ...
    \========================================================== */
        ...
        /* =========================================================
       RECHERCHE NAVBAR — CHANGEMENT AU SCROLL
    ========================================================== */
        ...
        .ak-nav-search-normal,
        .ak-nav-search-scroll {
            position: absolute;
            inset: 0;
            width: 100%;
            transition:
        ...
        .ak-nav-search-slot.is-scrolled .ak-nav-search-normal {
            opacity: 0;
            visibility: hidden;
            pointer-events: none;
            transform: translateY(5px);
        ...
        .ak-nav-search-slot.is-scrolled .ak-nav-search-scroll {
            opacity: 1;
            visibility: visible;
            pointer-events: auto;
            transform: translateY(0);
        ...
        .ak-nav-search-box input::placeholder {
            color: #94a3b8;
            font-weight: 500;
        }

        .ak-nav-search-box button {
            width: 28px;
            height: 28px;
            margin-right: 4px;
            flex-shrink: 0;
        ...
        .ak-nav-search-box button:hover {
        ...
        \====================================================== --}}
            ...
            <div class="h-[72px] flex items-center gap-3 sm:gap-4">
                ...
                {{-- RECHERCHE DANS LA NAVBAR
                     Au sommet : recherche normale.
                     Au scroll : elle se remplace dans exactement le même emplacement.
                --}}
                <div id="ak-nav-search-slot" class="ak-nav-search-slot hidden sm:block">

                    {{-- Recherche normale --}}
                    <form id="ak-nav-search-normal"
                          action="{{ $searchAction }}"
                          method="GET"
                          class="ak-nav-search-normal">

                        <div class="ak-nav-search-box">
                            <input type="text"
                                   name="q"
                                   value="{{ request('q') }}"
                    ...
                    {{-- Recherche compacte au scroll : elle reste dans la navbar --}}
                    <form id="ak-nav-search-scroll"
                          action="{{ $searchAction }}"
                          method="GET"
                          class="ak-nav-search-scroll">
                        ...
                        <div class="ak-nav-search-box">
                            <input type="text"
                                   ...
                                   placeholder="{{ $searchPlaceholder }}"
                                   autocomplete="off"
                                   aria-label="Rechercher rapidement">
...
\========================================================== --}}
    ...
    {{-- =========================================================
        SCRIPT : LA RECHERCHE RESTE DANS LA NAVBAR
        Au sommet : recherche normale.
        Au scroll : recherche compacte au même emplacement.
    ========================================================== --}}
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const searchSlot = document.getElementById('ak-nav-search-slot');
            ...
            const updateNavbarSearch = () => {
                searchSlot.classList.toggle('is-scrolled', window.scrollY > 120);
                ticking = false;
            };
            ...
            window.addEventListener('scroll', function () {
                if (!ticking) {
                    window.requestAnimationFrame(updateNavbarSearch);
                    ticking = true;
                }
            }, { passive: true });
        });
